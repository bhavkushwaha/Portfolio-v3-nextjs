    ...
    <section className="grid md:grid-cols-2 my-12 md:my-16 py-24 gap-4 relative" id="contact">
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md text-justify">
          ...
          Whether you have a question or just want to say hi, leave a message for me!
        </p>
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/bhavkushwaha">
            <Image src={GithubIcon} />
          </Link>
          <Link href="https://www.linkedin.com/in/bhavkushwaha/">
      ...
      <div>
        <form action={process.env.NEXT_PUBLIC_FORM_API_KEY} method="POST">
          ...
          <div class="mb-6">
            <button
              type="submit"
              class="bg-primary-500 hover:bg-secondary-600 text-white font-medium py-2.5 px-5 rounded-lg w-full"
            >
              {" "}
              Send message{" "}
            </button>
